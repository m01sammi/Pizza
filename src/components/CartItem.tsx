...
import { addItem, removeItem, minusItem, CartItem } from '../redux/slices/cartSlice.ts';
...
const CartItemBlock: React.FC <CartItemProps> = ({id, name, price, imageURL, sizes, types, count}) => {
